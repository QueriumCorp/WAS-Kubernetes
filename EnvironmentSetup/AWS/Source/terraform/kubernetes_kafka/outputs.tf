...
# date: Mar-2022
#
# usage: kafka module outputs
#------------------------------------------------------------------------------
output "helm_release_id" {
  description = "The ID of the kafka"
  value       = helm_release.kafka.id
}

output "helm_release_name" {
  description = "The name of the kafka"
  value       = helm_release.kafka.name
}

output "helm_release_namespace" {
  description = "The namespace of the kafka"
  value       = helm_release.kafka.namespace
}

output "helm_release_chart" {
  description = "The chart used to deploy kafka"
  value       = helm_release.kafka.chart
}

output "helm_release_repository" {
  description = "The repository used to deploy kafka"
  value       = helm_release.kafka.repository
}
